...
export const de: I18nDictionary = {
  ...
  "cmd.description.language": "Sprache des Bots ändern",
  ...
  "language.set.title": "🌐 Sprache des Bots:\n\nAktuell: {language}\n\nTippe auf eine Sprache, um zu wechseln:",
  "language.set.changed": "✅ Sprache auf {language} gesetzt",
  "language.set.error": "🔴 Sprache konnte nicht gesetzt werden",
